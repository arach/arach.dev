...
import CurrentMonthSpotlight from "./CurrentMonthSpotlight"
import TrailingMonths from "./TrailingMonths"
              ...
              >
                ...
                {stats && (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    {/* Current Month Spotlight - Spans 2 columns */}
                    <Card className="md:col-span-2 border-blue-200 bg-gradient-to-br from-blue-50/30 to-white">
                      <CardHeader className="pb-3">
                        ...
                        <CardDescription className="text-sm">
                          {new Date().toLocaleDateString("en-US", { month: "long", year: "numeric" })} - In Progress
                        </CardDescription>
                      </CardHeader>
